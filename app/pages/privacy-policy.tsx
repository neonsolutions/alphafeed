      ...
      <div className="text-gray-900 w-full flex justify-center pb-14">
        <div className="p-6 max-w-2xl">
          ...
          <p className="pt-3">
            ...
            ) that describes their collection and use of personal information. We do not control Stripe or its
            collection or use of information. Any questions or concerns about Stripe’s practices should be directed to
            Stripe.
          </p>
          <p className="pt-3">
            Stripe provides us with certain non-personal information relating to purchases and subscriptions made by
            visitors to the Website. The non-personal information may include details of the transaction such as the
            date, amount paid, and service subscribed to. The non-personal transaction information may be linked to the
            Personal Information you provide to us (typically limited to your email address, as stated above). Stripe
            does not supply us with any of your other Personal Information such as your name, street address, or credit
            card information.
          </p>
          <p className="pt-3">
            Our Service offers a monthly subscription which can be cancelled at any time through your account settings
