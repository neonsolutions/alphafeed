  ...
  return (
    <div className="text-gray-900 w-full flex justify-center pb-14">
      <div className="p-6 max-w-2xl">
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Interpretation and Definitions</h1>
        <h2 className="text-lg pt-4 font-bold">Interpretation</h2>
        <p className="pt-3">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h2 className="text-lg pt-4 font-bold">Definitions</h2>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            <p className="pt-3">
              ...
              &quot;Our&quot; in this Agreement) refers to Onset Carbon LLC, 419, 447 Broadway, 2nd Floor, New York, NY,
              New York, US, 10013.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className="pt-3">
              <strong>Website</strong> refers to Alpha, accessible from{" "}
              <a href="https://alphafeed.xyz" rel="external nofollow noopener" target="_blank">
                https://alphafeed.xyz
              </a>
            </p>
          </li>
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Collecting and Using Your Personal Data</h1>
        <h2 className="text-lg pt-4 font-bold">Types of Data Collected</h2>
        <h3>Personal Data</h3>
        <p className="pt-3">
        ...
        <ul className="list-disc pl-6">
          <li>
            <p className="pt-3">Email address</p>
          </li>
          <li>
            <p className="pt-3">First name and last name</p>
          </li>
          <li>
            <p className="pt-3">Usage Data</p>
          </li>
        </ul>
        <h3>Usage Data</h3>
        <p className="pt-3">Usage Data is collected automatically when using the Service.</p>
        <p className="pt-3">
        ...
        <ul className="list-disc pl-6 pt-4 pb-3">
          <li>
        ...
        <p className="pt-3">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className="list-disc pl-6">
          <li>
            <p className="pt-3">
              <strong>Necessary / Essential Cookies</strong>
            </p>
            <p className="pt-3">Type: Session Cookies</p>
            <p className="pt-3">Administered by: Us</p>
            <p className="pt-3">
          ...
          <li>
            ...
            <p className="pt-3">Type: Persistent Cookies</p>
            <p className="pt-3">Administered by: Us</p>
            <p className="pt-3">
        ...
        <h2 className="text-lg pt-4 font-bold">Use of Your Personal Data</h2>
        <p className="pt-3">The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc pl-6">
          <li>
            <p className="pt-3">
        ...
        <p className="pt-3">We may share Your personal information in the following situations:</p>
        ...
        <h2 className="text-lg pt-4 font-bold">Retention of Your Personal Data</h2>
        <p className="pt-3">
        ...
        <h2 className="text-lg pt-4 font-bold">Transfer of Your Personal Data</h2>
        <p className="pt-3">
        ...
        <h2 className="text-lg pt-4 font-bold">Delete Your Personal Data</h2>
        <p className="pt-3">
        ...
        <h2 className="text-lg pt-4 font-bold">Disclosure of Your Personal Data</h2>
        ...
        <h2 className="text-lg pt-4 font-bold">Security of Your Personal Data</h2>
        <p className="pt-3">
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Payment Processing</h1>
        <p className="pt-3">
          All purchases and subscriptions made through the Website are processed by a third-party payment processor,
          Stripe (stripe.com). Stripe may ask you for personal and/or non-personal information, such as your name,
          address, email address, credit card information, or other Personal Information. Stripe has a privacy policy (
          <a href="https://stripe.com/privacy" rel="external nofollow noopener" target="_blank">
            stripe.com/privacy
          </a>
          ) that describes their collection and use of personal information. We do not control Stripe or its collection
          or use of information. Any questions or concerns about Stripe’s practices should be directed to Stripe.
        </p>
        <p className="pt-3">
          Stripe provides us with certain non-personal information relating to purchases and subscriptions made by
          visitors to the Website. The non-personal information may include details of the transaction such as the date,
          amount paid, and service subscribed to. The non-personal transaction information may be linked to the Personal
          Information you provide to us (typically limited to your email address, as stated above). Stripe does not
          supply us with any of your other Personal Information such as your name, street address, or credit card
          information.
        </p>
        <p className="pt-3">
          Our Service offers a monthly subscription which can be cancelled at any time through your account settings or
          by contacting our customer service team.
        </p>
        <h1 className="text-2xl font-bold pb-3 pt-7">Children's Privacy</h1>
        <p className="pt-3">
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Links to Other Websites</h1>
        <p className="pt-3">
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Changes to this Privacy Policy</h1>
        <p className="pt-3">
        ...
        <h1 className="text-2xl font-bold pb-3 pt-7">Contact Us</h1>
        <p className="pt-3">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className="list-disc pl-6">
          <li>By email: hello@alphafeed.xyz</li>
        </ul>
      </div>
    </div>
  )
