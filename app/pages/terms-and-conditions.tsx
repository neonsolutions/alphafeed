  ...
  return (
    <div className="text-gray-900 w-full flex justify-center pb-14">
      <div className="p-6 max-w-2xl">
        ...
        <p className="pt-3">
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Alpha if you
        ...
        <p className="pt-3">You must not:</p>
        <ul className="list-disc pl-6 pt-2">
          <li>Republish material from Alpha</li>
          <li>Sell, rent or sub-license material from Alpha</li>
          <li>Reproduce, duplicate or copy material from Alpha</li>
        ...
        <p className="pt-3">The following organizations may link to our Website without prior written approval:</p>
