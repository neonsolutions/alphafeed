  ...
  return (
    <div>
      ...
      <div className="bg-white w-full py-32  border-t-2 border-gray-200 z-10 relative text-black h-full flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 w-full max-w-4xl">
          ...
          <div className="flex justify-center content-center px-6 order-1 sm:order-2">
            <div>
              <h2 className="text-3xl font-bold leading-tight  text-gray-900 sm:text-4xl  pb-10">
                How It Works
              </h2>
              <div className="max-w-[420px] sm:max-w-[380]">
                <p className="text-gray-900 font-medium text-lg">Discover</p>
                <p className="text-gray-600  text-base">
                  AI algorithms scan thousands of news sources, blogs, forums,
                  and academic journals, identifying the latest and most
                  relevant AI news
                </p>
                <p className="text-gray-900 font-medium text-lg pt-4">
                  Analyse
                </p>
                <p className="text-gray-600  text-base">
                  Our AI evaluates each piece of content, analysing its
                  relevance and insightfulness. It filters out the noise,
                  leaving only the most valuable information.
                </p>
                <p className="text-gray-900 font-medium text-lg pt-4">
                  Personalise
                </p>
                <p className="text-gray-600  text-base">
                  Alpha learns from your reading habits and preferences,
                  tailoring its content curation to your unique interests. The
                  more you use Alpha
                </p>
              </div>
            </div>
      ...
      <div className="px-6 lg:px-8 py-32  border-t-2 border-gray-200 flex justify-center ">
        <div>
          <h2 className="text-3xl font-bold leading-tight  text-gray-900 sm:text-4xl   text-center pb-14">
            Pricing
          </h2>
          <div className="mx-auto max-w-3xl rounded-3xl ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-[840px]">
            <div className="p-8 sm:p-10 lg:flex-auto sm:max-w-[550px]">
              ...
              <p className="mt-6 text-base leading-5 text-gray-600">
                Unlock the full power of Alpha with our All-Access Subscription.
                Stay ahead of the AI curve with unlimited access to curated
                content, personalized recommendations, and exclusive features.
              </p>
