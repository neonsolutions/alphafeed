...
const posts: IFeedPost[] = [
  {
    ...
    media: {
      images: ["https://nitter.net/pic/amplify_video_thumb%2F1662844490632052736%2Fimg%2FwC0Qi23gmCWw3Bcx.jpg"],
      videos: [],
    },
  ...
  },
  {
    ...
    media: { images: ["https://nitter.net/pic/video.twimg.com%2Ftweet_video%2FFw-2HE4aEAcb0zh.mp4"], videos: [] },
  ...
  },
  {
    ...
    media: { images: ["https://nitter.net/pic/media%2FFxRg6zhWwAIXX9g.jpg"], videos: [] },
  ...
  },
  {
    ...
    media: { images: ["https://nitter.net/pic/media%2FFxD4qgdXgAETxfB.jpg"], videos: [] },
  ...
  },
  {
    ...
    media: { images: ["https://nitter.net/pic/media%2FFxEtDy-WAAATkOU.jpg"], videos: [] },
